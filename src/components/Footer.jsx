...
const tweetList = [
    {
        iconName: 'icofont-twitter',
        desc: "@MeowCat Greetings! Grab your item, 50% Big Sale Offer !!"
    },
    {
        iconName: 'icofont-twitter',
        desc: "@MeowCat Hey! Grab your item, 50% Big Sale Offer !!"
    },
]
        ...
        <div className='footer-bottom'>
            <div className="container">
                <div className="section-wrapper">
                    <p>&copy; 2023 <Link to="/">Shop Cart</Link> Designed by <a href="/" target="_blank">QWM</a></p>
