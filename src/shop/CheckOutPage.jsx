                        ...
                        <div className="tabs mt-3">
                            <ul className='nav nav-tabs' id="myTab" role="tablist">
                                <li className='nav-item' role="presentation">
                                    ...
                                    href="#visa"><img src="https://burhan.ua/wp-content/uploads/2019/09/Visa-Mastercard-Logo-12-1-1019x596.jpg" alt="" 
                                    width="80"/>
                                    </a>
                                </li>
                                <li className='nav-item' role="presentation">
                                    ...
                                    href="#paypal"><img src="https://newsroom.paypal-corp.com/image/pp_h_rgb_logo_tn.jpg" alt="" 
                                    width="80"/>
                                    </a>
                                </li>
                            </ul>
